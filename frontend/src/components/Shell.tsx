 ...
 *
 * The rail visualizes the pipeline workflow: completed steps carry a checkmark, while
 * steps whose prerequisites are unmet are disabled with the requirement in a tooltip.
 */
