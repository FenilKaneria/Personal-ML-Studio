 ...
 *
 * The step order defines the pipeline dependency chain. It enables the rail to lock
 * steps whose prerequisites are unmet and reset downstream state when upstream data changes,
 * aligned with the server's `reset_downstream` cascade.
 */
